...
*/
/**
* @violates @ref Uart_PBcfg_c_REF_3 Function with external linkage is not visible.
* @violates @ref Uart_PBcfg_c_REF_4 These functions
                 represent the API of the driver. External linkage is needed to "export" the API.
* @violates @ref Uart_PBcfg_c_REF_5 This violation is due to exporting
