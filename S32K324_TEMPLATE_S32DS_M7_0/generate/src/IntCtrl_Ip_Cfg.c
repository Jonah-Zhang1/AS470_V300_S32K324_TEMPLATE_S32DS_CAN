...
#include "Platform_MemMap.h"
    ...
    static const IntCtrl_Ip_IrqConfigType aIrqConfiguration[] = {
        ...
        {EMAC_0_IRQn, (boolean)FALSE, 0U, GMAC0_Common_IRQHandler},
        {EMAC_1_IRQn, (boolean)FALSE, 0U, GMAC0_CH_TX_IRQHandler},
        {EMAC_2_IRQn, (boolean)FALSE, 0U, GMAC0_CH_RX_IRQHandler},
        {EMAC_3_IRQn, (boolean)FALSE, 0U, GMAC0_Safety_IRQHandler},
