...
*
*/
Can_43_FLEXCAN_DriverStatusType Can_43_FLEXCAN_GetDriverStatus(uint8 instance)
{
...
*
*/
const Can_43_FLEXCAN_ConfigType * Can_43_FLEXCAN_GetDriverConfig(uint8 instance)
{
