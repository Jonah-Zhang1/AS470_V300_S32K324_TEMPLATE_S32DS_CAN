...
#if (CAN_43_FLEXCAN_TIMESTAMP_ENABLE == STD_ON)
#define CAN_43_FLEXCAN_SID_GET_CURRENT_TIME                        ((uint8)0x13)
#define CAN_43_FLEXCAN_SID_ENABLE_EGRESS_TIMESTAMP                 ((uint8)0x14)
#define CAN_43_FLEXCAN_SID_GET_EGRESS_TIMESTAMP                    ((uint8)0x15)
#define CAN_43_FLEXCAN_SID_GET_INGRESS_TIMESTAMP                   ((uint8)0x16)
